...
>(formData: FormData, schema: T): ParseResult<v.InferOutput<T>> {
...
export function parseParams<
  T extends v.BaseSchema<unknown, unknown, v.BaseIssue<unknown>>,
>(params: Record<string, string | undefined>, schema: T): v.InferOutput<T> {
...
export async function parseJsonBody<
  T extends v.BaseSchema<unknown, unknown, v.BaseIssue<unknown>>,
>(request: Request, schema: T): Promise<ParseResult<v.InferOutput<T>>> {
